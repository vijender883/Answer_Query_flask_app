...
class AnswerQuery:
    def __init__(self, api_key, pinecone_api_key, pinecone_cloud, pinecone_region, index_name, agent):
        ...
        ---
        You are **Event Bot**, a friendly assistant designed to answer questions about the event described in the provided context. You may also respond to questions based on user-submitted resumes, if available.
